...
──────────────────────
有限会社マックエージェンシー　山野
新潟県見附市本所1-25-19　　〒954-0051
TEL 090-7289-4281
URL  http://www.mac-agency.com
mail　info@mac-agency.com
──────────────────────
...
//変換前の文字
$replaceStr['before'] = array();//UTF-8版以外では設定するよ文字化け等の問題があるため設定しないでください。
//変換後の文字
$replaceStr['after'] = array();//UTF-8版以外では設定するよ文字化け等の問題があるため設定しないでください。
...
$encode = "euc-jp";//このファイルの文字コード定義（変更不可）
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="https://mac-agency.com/" target="_blank">- mac-agency -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
